...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.pgsql_local.driver' => 'string',
            'database.connections.pgsql_local.host' => 'string',
            'database.connections.pgsql_local.port' => 'string',
            'database.connections.pgsql_local.database' => 'string',
            'database.connections.pgsql_local.username' => 'string',
            'database.connections.pgsql_local.password' => 'string',
            'database.connections.pgsql_local.charset' => 'string',
            'database.connections.pgsql_local.prefix' => 'string',
            'database.connections.pgsql_local.prefix_indexes' => 'boolean',
            'database.connections.pgsql_local.search_path' => 'string',
            'database.connections.pgsql_local.sslmode' => 'string',
            ...
            'filesystems.links./Users/khoabuw/Desktop/R2O/cc-web-app/be-cc-web-app/public/storage' => 'string',
            ...
            'queue.connections.rabbitmq.options.exchange.name' => 'string',
            'queue.connections.rabbitmq.options.exchange.type' => 'string',
            'queue.connections.rabbitmq.options.exchange.declare' => 'boolean',
            'queue.connections.rabbitmq.options.exchange.passive' => 'boolean',
            'queue.connections.rabbitmq.options.exchange.durable' => 'boolean',
            'queue.connections.rabbitmq.options.exchange.auto_delete' => 'boolean',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.pgsql_local.driver','database.connections.pgsql_local.host','database.connections.pgsql_local.port',
'database.connections.pgsql_local.database','database.connections.pgsql_local.username','database.connections.pgsql_local.password','database.connections.pgsql_local.charset','database.connections.pgsql_local.prefix',
'database.connections.pgsql_local.prefix_indexes','database.connections.pgsql_local.search_path','database.connections.pgsql_local.sslmode','database.migrations.table','database.migrations.update_date_on_publish',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/khoabuw/Desktop/R2O/cc-web-app/be-cc-web-app/public/storage','logging.default',
...
'queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost','queue.connections.rabbitmq.options.exchange.name','queue.connections.rabbitmq.options.exchange.type','queue.connections.rabbitmq.options.exchange.declare',
'queue.connections.rabbitmq.options.exchange.passive','queue.connections.rabbitmq.options.exchange.durable','queue.connections.rabbitmq.options.exchange.auto_delete','queue.connections.rabbitmq.options.queue.job','queue.connections.rabbitmq.worker',
...
'session.http_only','session.same_site','session.partitioned','browser-detect.cache.interval','browser-detect.cache.prefix',
'browser-detect.security.max-header-length','location.driver','location.fallbacks','location.position','location.http.timeout',
...
'RABBITMQ_PORT','RABBITMQ_USER','RABBITMQ_PASSWORD','RABBITMQ_VHOST','RABBITMQ_QUEUE_LOGIN',
